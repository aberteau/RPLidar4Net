    ...
    public class LidarConfigDataResponseHelper
    {
        public static LidarConfigDataResponse ToLidarConfigDataResponse(byte[] data)
        {
            ...
            switch(data[0])
            {
                ...
                case (byte)LidarConfigType.MinRotationFrequency: dataResponse.MinRotationFrequency = BitConverter.ToUInt16(data, 4); break;
                case (byte)LidarConfigType.MaxRotationFrequency: dataResponse.MaxRotationFrequency = BitConverter.ToUInt16(data, 4); break;
